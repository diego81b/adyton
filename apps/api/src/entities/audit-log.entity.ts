...
export enum AuditAction {
  ...
  PAK_DEVICE_ENROLLED = 'PAK_DEVICE_ENROLLED',
  PAK_DEVICE_REVOKED = 'PAK_DEVICE_REVOKED',
  PAK_QR_APPROVED = 'PAK_QR_APPROVED',
  PAK_QR_DENIED = 'PAK_QR_DENIED',
  PAK_RECOVERY_KIT_CREATED = 'PAK_RECOVERY_KIT_CREATED',
  PAK_RECOVERY_KIT_USED = 'PAK_RECOVERY_KIT_USED',
  PAK_RECOVERY_KIT_REVOKED = 'PAK_RECOVERY_KIT_REVOKED',
