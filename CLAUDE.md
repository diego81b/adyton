...
- **Verified:** web 411 tests green, typecheck + lint clean, `nuxt generate` + `cap sync` both platforms OK. Remaining for phase closure: Gradle/Xcode build + on-device smoke (Android Studio / macOS needed).
