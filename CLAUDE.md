...
**Phase 5 steps complete (0–5; 3 dropped).** Remaining before Phase 6: integration tests for settings/account-deletion need Docker (written, not yet run); browser smoke of `/generator` + `/settings`; MikroORM snapshot regen.
